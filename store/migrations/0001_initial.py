    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('membership', models.CharField(choices=[('MEMBERSHIP_BRONZE', 'Bronze'), ('MEMBERSHIP_SILVER', 'Silver'), ('MEMBERSHIP_CHOICES', 'Gold')], default='MEMBERSHIP_BRONZE', max_length=255)),
            ],
        ),
        migrations.CreateModel(
            name='Promotion',
